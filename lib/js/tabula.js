...
Tabula.DataView = Backbone.View.extend({  // one per query object.
  ...
  initialize: function(stuff){
    _.bindAll(this, 'render', 'renderFlashClipboardNonsense', 'updateFilename', 'queryWithToggledExtractionMethod', 'closeAndRenderSelectionView', 'setFormAction', 'preview');
  ...
  preview: function(e) {
    ...
    $.ajax({
      ...
      success: _.bind(function(data) {
        ...
        ReactDOM.render(React.createElement(PeopleView, {'people': data}), document.getElementById('people-container'));
      }, this),
      cache: false,
      contentType: false,
      processData: false
